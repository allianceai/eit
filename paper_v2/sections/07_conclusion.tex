...
the minority deficit is predominantly threshold-recoverable (mean $68\%$, $80\%$ at
imbalance ratio $>3$): the classifier's scores already place these instances above
a tuned operating point and only the default cutoff is wrong. This accounts mechanistically for a documented but
