...
$\approx0.59$, are the near-irreducible problems.) The result is also not an
artefact of the random-forest instrument: re-deriving the full decomposition
with bagged MLP and bagged logistic-regression ensembles leaves the
threshold-recoverable share at $69\%$ and $68\%$ respectively ($77\%$ at
$\mathrm{IR}>3$ for both; \appref{app:nontree}).
...
space. That is a \emph{prior shift}, not a calibration improvement --- it can be
reproduced without data generation by reweighting or by moving the threshold
(Table~\ref{tab:parity}), and undone by post-hoc recalibration
...
of \appref{app:nontree} reproduces the $69\%$ threshold-recoverable share ---
