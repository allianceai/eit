...
corrupts, are the exception. We give the mechanism: on controlled mixtures with a
\emph{known} Bayes boundary, standard SMOTE places an overlap-dependent fraction of
synthetic points \emph{across} it, and a short proposition shows why interpolating
boundary seeds crosses into majority-posterior space. Once every strategy receives
