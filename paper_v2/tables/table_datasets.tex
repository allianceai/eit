...
\caption{Full dataset listing (54 datasets; the recovered original-paper roster). $n$ = instances; $d$ = features; $C$ = classes; IR = imbalance ratio (majority / minority count).}\label{tab:datasets}\\
\toprule
...
\texttt{iris} & -1 & 150 & 4 & 3 & 1.0 \\
\texttt{wine} & -2 & 178 & 13 & 3 & 1.5 \\
\texttt{breast\_cancer} & -3 & 569 & 30 & 2 & 1.7 \\
\texttt{digits} & -4 & 1797 & 64 & 10 & 1.1 \\
