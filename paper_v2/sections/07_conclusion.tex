...
We introduced a remedy decomposition of the misclassified minority class --- sorting
...
unexplained regularity --- that oversampling does not improve ranking and a threshold
move reproduces its benefit without synthetic generation and with better calibration --- and
recasts the long-observed accuracy/recall tradeoff as an operating-point effect:
oversampling is an implicit, inefficient enactment of a threshold shift, which on
